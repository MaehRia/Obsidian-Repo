...
Հաշվենք z ֆունկցիայի մասնակի ածանցյալները ըստ x-ի և y-ի և տեղադրենք պահանջով տրվող հավասարման մեջ։ 
...
= x'_y \times (e^{\frac{y}{x^2}}) +x \times (e^{\frac{y}{x^2}})' \times \left(\frac{y}{x^2}\right)'_y
\end{align}
$$